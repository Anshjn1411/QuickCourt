// data/repository/WebSocketManager.kt
...
class WebSocketManager(private val matchId: String) {
    ...
    suspend fun connect() {
        try {
            ...
            client.webSocket(
                ...
                Log.d("WebSocket", "Connected to match $matchId")
                ...
                try {
                    ...
                    Log.e("WebSocket", "Error in message loop", e)
                } finally {
    ...
    suspend fun sendScoreUpdate(scoreA: Int, scoreB: Int) {
        session?.let { s ->
            try {
                ...
                Log.d("WebSocket", "Sending score update: $json")
                s.send(json)
            } catch (e: Exception) {
                Log.e("WebSocket", "Failed to send score update", e)
            }
        }
    }
    ...
    suspend fun sendCricketScoreUpdate(scoreUpdate: CricketScorePayload) {
        session?.let { s ->
            try {
                val message = ClientMessage.ScoreUpdate(scoreUpdate)
                val json = Json.encodeToString<ClientMessage>(message)
                Log.d("WebSocket", "Sending cricket score update: $json")
                s.send(json)
            } catch (e: Exception) {
                Log.e("WebSocket", "Failed to send cricket score update", e)
            }
        }
    }
    ...
    suspend fun updateInnings(innings: CricketInnings) {
        session?.let { s ->
            try {
                ...
                Log.e("WebSocket", "Failed to update innings", e)
            }
        }
    }
    ...
    suspend fun updateBowler(bowler: Bowler) {
        session?.let { s ->
            try {
                ...
                Log.e("WebSocket", "Failed to update bowler", e)
            }
        }
    }
    ...
    suspend fun updateBatsman(batsman: Batsman) {
        session?.let { s ->
            try {
                ...
                Log.e("WebSocket", "Failed to update batsman", e)
            }
        }
    }
    ...
    suspend fun requestSnapshot() {
        session?.let { s ->
            try {
                ...
                Log.e("WebSocket", "Failed to request snapshot", e)
            }
        }
    }
